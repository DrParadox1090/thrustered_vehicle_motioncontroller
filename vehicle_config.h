...
#define SURGE_VECTOR {1,1,1,1}
#define SWAY_VECTOR  {1,1,1,1}
#define HEAVE_VECTOR {1,1,1,1}
#define YAW_VECTOR   {1,1,1,1}
#define PITCH_VECTOR {1,1,1,1} 
#define ROLL_VECTOR  {1,1,1,1}
